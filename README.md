...
A port of [FastLZ](https://github.com/ariya/FastLZ) to rust (using c2rust).

**Very WIP!!**
Started during the 33rd Torino Hacknight [(link - IT)](https://github.com/tohacknight/rustoxidation).
